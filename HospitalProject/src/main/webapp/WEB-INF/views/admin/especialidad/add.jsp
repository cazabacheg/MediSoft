...
<title>Especialidad : Registrar</title>
</head>
<body>
	...
	<div class="container">
		...
		<div class="col-md-12">
			...
			<form action="add-especialidad" method="post">
				...
				<div class="form-group">
					<label for="precio">Precio <b class="text-danger">*</b></label> <input
						class="form-control" type="number" name="precio" min="0" step="0.01" required>
				</div>
